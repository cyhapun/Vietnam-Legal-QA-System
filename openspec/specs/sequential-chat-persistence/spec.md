...
Đảm bảo dữ liệu các phiên trò chuyện và tin nhắn liên quan (user, assistant) được lưu vào PostgreSQL một cách tuần tự và nhất quán, loại bỏ nguy cơ race condition do foreign key constraint khi lưu đồng thời.
